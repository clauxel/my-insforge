const visitorStorageKey = 'insforge-analytics-visitor'
const sessionStorageKey = 'insforge-analytics-session'
const queueStorageKey = 'insforge-analytics-queue'
const sessionInactivityMs = 30 * 60 * 1000
const flushDelayMs = 1800
const maxQueueLength = 80
