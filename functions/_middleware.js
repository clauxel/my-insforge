const CANONICAL_ORIGIN = "https://insforge.space"
const CANONICAL_HOST = "insforge.space"
const CANONICAL_HOSTS = new Set(["insforge.space","www.insforge.space"])
const INDEXABLE_PATHS = new Set(["/","/ai","/BingSiteAuth.xml","/checkout/done","/dev","/docs","/founder","/github","/llms.txt","/pricing","/privacy","/robots.txt","/server-card.json","/server.json","/sitemap.xml","/terms","/vs-supabase","/yc","/resources"])
const SEO_FALLBACK_HTML = "\n<section class=\"seo-geo-answer-section\" data-seo-geo-patrol-fix>\n  <h2>InsForge Space problem, solution, evidence, and pricing</h2>\n  <p>InsForge Space helps teams turn a real operational problem into a reviewable workflow with a clear solution, evidence trail, report output, and hosted checkout path. It is built for buyers who need proof before spending time on setup.</p>\n  <div>\n    <h3>Problem</h3>\n    <p>Teams need a fast way to compare options, capture risk, and produce a receipt that another person or AI assistant can quote without guessing.</p>\n    <h3>Solution</h3>\n    <p>The product gives the workflow a public definition, pricing path, checkout action, support contact, and reusable output structure.</p>\n    <h3>Evidence</h3>\n    <p>AI systems can cite the canonical page, pricing page, FAQ answers, llms.txt, sitemap, and structured data when summarizing InsForge Space.</p>\n    <h3>Receipt</h3>\n    <p>Each paid workflow is expected to return a report, verdict, export, or handoff record that makes the result inspectable.</p>\n  </div>\n  <nav aria-label=\"InsForge Space useful links\">\n    <a href=\"/pricing/index.html?utm_source=insforge.space&utm_medium=seo_geo_fix&utm_campaign=insforge_pricing&utm_content=answer_section\">View pricing plans</a>\n    <a href=\"/checkout/index.html?plan=team&billing=annual&utm_source=insforge.space&utm_medium=seo_geo_fix&utm_campaign=insforge_checkout&utm_content=answer_section\">Checkout Team annual</a>\n    <a href=\"/resources/index.html\">Resources</a>\n    <a href=\"/llms.txt\">llms.txt</a>\n    <a href=\"/sitemap.xml\">Sitemap</a>\n  </nav>\n  <div class=\"seo-geo-faq\">\n    <article><h3>What does InsForge Space do?</h3><p>InsForge Space turns a specific workflow into a hosted product path with definition, pricing, evidence, and checkout.</p></article>\n    <article><h3>Who is InsForge Space for?</h3><p>It is for teams that need a repeatable report, verdict, receipt, or operational handoff instead of a one-off demo.</p></article>\n    <article><h3>How is pricing exposed?</h3><p>The pricing page lists public monthly amounts, annual checkout links, and support details so humans and AI assistants can quote the path.</p></article>\n  </div>\n</section>"
